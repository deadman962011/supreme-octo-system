import 'dart:convert';
import 'package:shamel_delivery_app/common/controllers/theme_controller.dart';
import 'package:shamel_delivery_app/api/api_client.dart';
import 'package:shamel_delivery_app/features/address/controllers/address_controller.dart';
import 'package:shamel_delivery_app/features/address/domain/repositories/address_repository.dart';
import 'package:shamel_delivery_app/features/address/domain/repositories/address_repository_interface.dart';
import 'package:shamel_delivery_app/features/address/domain/services/address_service.dart';
import 'package:shamel_delivery_app/features/address/domain/services/address_service_interface.dart';
import 'package:shamel_delivery_app/features/auth/controllers/auth_controller.dart';
import 'package:shamel_delivery_app/features/auth/domain/repositories/auth_repository.dart';
import 'package:shamel_delivery_app/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:shamel_delivery_app/features/auth/domain/services/auth_service.dart';
import 'package:shamel_delivery_app/features/auth/domain/services/auth_service_interface.dart';
import 'package:shamel_delivery_app/features/cash_in_hand/controllers/cash_in_hand_controller.dart';
import 'package:shamel_delivery_app/features/cash_in_hand/domain/repositories/cash_in_hand_repository.dart';
import 'package:shamel_delivery_app/features/cash_in_hand/domain/repositories/cash_in_hand_repository_interface.dart';
import 'package:shamel_delivery_app/features/cash_in_hand/domain/services/cash_in_hand_service.dart';
import 'package:shamel_delivery_app/features/cash_in_hand/domain/services/cash_in_hand_service_interface.dart';
import 'package:shamel_delivery_app/features/chat/controllers/chat_controller.dart';
import 'package:shamel_delivery_app/features/chat/domain/repositories/chat_repository.dart';
import 'package:shamel_delivery_app/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:shamel_delivery_app/features/chat/domain/services/chat_service.dart';
import 'package:shamel_delivery_app/features/chat/domain/services/chat_service_interface.dart';
import 'package:shamel_delivery_app/features/disbursement/controllers/disbursement_controller.dart';
import 'package:shamel_delivery_app/features/disbursement/domain/repositories/disbursement_repository.dart';
import 'package:shamel_delivery_app/features/disbursement/domain/repositories/disbursement_repository_interface.dart';
import 'package:shamel_delivery_app/features/disbursement/domain/services/disbursement_service.dart';
import 'package:shamel_delivery_app/features/disbursement/domain/services/disbursement_service_interface.dart';
import 'package:shamel_delivery_app/features/forgot_password/controllers/forgot_password_controller.dart';
import 'package:shamel_delivery_app/features/forgot_password/domain/repositories/forgot_password_repository.dart';
...
import 'package:shamel_delivery_app/features/forgot_password/domain/services/forgot_password_service.dart';
import 'package:shamel_delivery_app/features/forgot_password/domain/services/forgot_password_service_interface.dart';
import 'package:shamel_delivery_app/features/html/controllers/html_controller.dart';
import 'package:shamel_delivery_app/features/html/domain/repositories/html_repository.dart';
import 'package:shamel_delivery_app/features/html/domain/repositories/html_repository_interface.dart';
import 'package:shamel_delivery_app/features/html/domain/services/html_service.dart';
import 'package:shamel_delivery_app/features/html/domain/services/html_service_interface.dart';
import 'package:shamel_delivery_app/features/language/controllers/language_controller.dart';
import 'package:shamel_delivery_app/features/language/domain/repositories/language_repository.dart';
import 'package:shamel_delivery_app/features/language/domain/repositories/language_repository_interface.dart';
import 'package:shamel_delivery_app/features/language/domain/services/language_service.dart';
import 'package:shamel_delivery_app/features/language/domain/services/language_service_interface.dart';
import 'package:shamel_delivery_app/features/notification/controllers/notification_controller.dart';
import 'package:shamel_delivery_app/features/notification/domain/repositories/notification_repository.dart';
import 'package:shamel_delivery_app/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:shamel_delivery_app/features/notification/domain/services/notification_service.dart';
import 'package:shamel_delivery_app/features/notification/domain/services/notification_service_interface.dart';
import 'package:shamel_delivery_app/features/order/controllers/order_controller.dart';
import 'package:shamel_delivery_app/features/order/domain/repositories/order_repository.dart';
import 'package:shamel_delivery_app/features/order/domain/repositories/order_repository_interface.dart';
import 'package:shamel_delivery_app/features/order/domain/services/order_service.dart';
import 'package:shamel_delivery_app/features/order/domain/services/order_service_interface.dart';
import 'package:shamel_delivery_app/features/profile/controllers/profile_controller.dart';
import 'package:shamel_delivery_app/features/profile/domain/repositories/profile_repository.dart';
import 'package:shamel_delivery_app/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:shamel_delivery_app/features/profile/domain/services/profile_service.dart';
import 'package:shamel_delivery_app/features/profile/domain/services/profile_service_interface.dart';
import 'package:shamel_delivery_app/features/splash/controllers/splash_controller.dart';
import 'package:shamel_delivery_app/features/splash/domain/repositories/splash_repository.dart';
import 'package:shamel_delivery_app/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:shamel_delivery_app/features/splash/domain/services/splash_service.dart';
...
import 'package:shamel_delivery_app/features/language/domain/models/language_model.dart';
