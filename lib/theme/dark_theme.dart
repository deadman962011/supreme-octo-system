...
ThemeData dark = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF560BAD))),
  colorScheme: const ColorScheme.dark(primary: const Color(0xFF560BAD), secondary: const Color(0xFF7209B7)).copyWith(error: const Color(0xFFdd3135)),
